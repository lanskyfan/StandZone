...
//    }
    var body: some View {
        VStack {
            ...
            FrequencyGraph(myController: myController, healthController: healthController)
                .padding()
            TimeGraph()
                .padding()
        }
...
//        let buildFitness = Legend(color: .yellow, label: "Build Fitness", order: 4)
        ...
        let data = healthController.produceStatistics()
        let points: [DataPoint] = [
            .init(value: data[0], label: "Mon", legend: low),
                        .init(value: data[1], label: "Tue", legend: warmUp),
                        .init(value: data[2], label: "Wed", legend: warmUp),
                        .init(value: 10, label: "Thur", legend: fatBurning),
                        .init(value: data[4], label: "Fri", legend: fatBurning),
                        .init(value: data[5], label: "Sat", legend: fatBurning),
                        .init(value: data[6], label: "Sun", legend: fatBurning),
